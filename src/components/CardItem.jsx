...
function CardItem({ product }) {
  ...
  return (
    <div className='relative flex flex-col justify-between  cursor-pointer bg-gray-200 mt-6 rounded-t-2xl rounded-b-lg overflow-hidden'>
      ...
      <div className='p-4'>
        <h2 className='text-lg font-semibold text-orange-500 uppercase max-w-[208px] truncate mt-3 px-3'>{name}</h2>
        ...
        {discount && <p className=' text-white absolute left-0 bottom-[190px] px-7 translate-y-[19px] rounded-bl-2xl rounded-tr-2xl bg-[#ffb30e] py-5  flex items-center'><span className='font-bold text-6xl'>{discount}</span>
